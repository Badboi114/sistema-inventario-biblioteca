...
class ActivoBibliografico(models.Model):
    ...
    estado = models.CharField(max_length=20, choices=ESTADO_CHOICES, default='BUENO', verbose_name='Estado')
...
class TrabajoGrado(ActivoBibliografico):
    ...
    modalidad = models.CharField(max_length=30, choices=MODALIDAD_CHOICES, verbose_name='Modalidad')
